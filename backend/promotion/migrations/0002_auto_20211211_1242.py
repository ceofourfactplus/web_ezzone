...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0002_auto_20211211_1242'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='rewards',
            name='update_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rewards_update_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
