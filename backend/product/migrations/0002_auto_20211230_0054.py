...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='create_by',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='add_product_create_by', to=settings.AUTH_USER_MODEL),
        ...
        migrations.AddField(
            model_name='pricetopping',
            name='topping',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='product.Topping'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='product.ToppingCategory'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='settopping',
        ...
        migrations.AddField(
            model_name='topping',
            name='old_product',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, to='product.Topping'),
        ),
        migrations.AddField(
            model_name='topping',
            name='unit',
        ...
        migrations.AddField(
            ...
            name='create_by',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='topping_category_create_by', to=settings.AUTH_USER_MODEL),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='toppingcategory',
